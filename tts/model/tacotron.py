...
class Tacotron(nn.Module):
    def __init__(self, num_chars, num_mels=80, embed_dim=512, prenet_dim=256,
                 attention_lstm_dim=1024, decoder_lstm_dim=1024, attention_dim=128,
                 encoder_layers=3, kernel_size=5, postnet_layers=3, postnet_channels=512,
                 attention_dropout=0.1, dropout=0.5, max_frames=870, threshold=0.5, frames_per_char=5.75):
        ...
        self.decoder = Decoder(num_mels, prenet_dim, embed_dim,
                               ...
                               attention_dim, attention_dropout, dropout,
                               max_frames, threshold, frames_per_char)
...
def tacotron(num_chars, params):
    return Tacotron(num_chars, params.num_mels, params.embed_dim, params.prenet_dim,
                    params.attention_lstm_dim, params.decoder_lstm_dim, params.attention_dim,
                    params.encoder_layers, params.kernel_size, params.postnet_layers, params.postnet_channels,
                    params.attention_dropout, params.dropout, params.max_frames, params.threshold, params.frames_per_char)
