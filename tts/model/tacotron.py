...
class Tacotron(nn.Module):
    def __init__(self, num_chars, num_mels=80, embed_dim=512, prenet_dim=256,
                 ...
                 attention_dropout=0.1, dropout=0.5, teacher_forcing=0.5,
                 max_frames=870, threshold=0.5, frames_per_char=5.75):
        ...
        self.decoder = Decoder(num_mels, prenet_dim, embed_dim,
                               ...
                               dropout, teacher_forcing, max_frames, threshold,
                               frames_per_char)
...
def tacotron(num_chars, params):
    return Tacotron(num_chars, params.num_mels, params.embed_dim, params.prenet_dim,
                    ...
                    params.attention_dropout, params.dropout, params.teacher_forcing,
                    params.max_frames, params.threshold, params.frames_per_char)
